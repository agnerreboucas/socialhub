...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Social Hub — Ampliação Marketing Digital" },
      {
        name: "description",
        content:
          "Plataforma de gestão e métricas de redes sociais: crescimento, publicação, impulsionamento e caixa de entrada unificada.",
      },
      { name: "author", content: "Ampliação Marketing Digital" },
      { property: "og:title", content: "Social Hub — Ampliação Marketing Digital" },
      {
      ...
      { name: "twitter:title", content: "Social Hub — Ampliação Marketing Digital" },
      {
